...
const ShapeGrid = ({
  ...
  useEffect(() => {
    ...
    // ✅ KEY FIX: listen on WINDOW not canvas
    // This way hover works even when page content is on top
    ...
    // ✅ Listen on window so mouse events work through overlapping elements
